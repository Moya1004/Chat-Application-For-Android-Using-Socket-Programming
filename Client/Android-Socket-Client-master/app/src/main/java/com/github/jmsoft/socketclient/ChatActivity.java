...
public class ChatActivity extends AppCompatActivity implements ActivityGenericsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionTask = new ConnectionTask(ia, mPort, this, messages, mChatAdapter,mIdentification);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!etMessage.getText().toString().equals("")) {
                    ...
                    //Start Send Task
                    messageTask = new SendMessageTask(connectionTask.oos,connectionTask.getsSocket(), etMessage, mIdentification, getApplicationContext());
    ...
    public void initializeUIComponents() throws SQLException {
        ...
        int id = db.getUserIDByUsername("Yusuf");
        ResultSet rs =  db.getMessage(id);;
        try {
            if (rs != null)
            while (rs.next())
            {
                ...
                messages.add(date + " " + sender +": " + message);
                mChatAdapter.notifyDataSetChanged();
            }
        } catch (SQLException e) {
            e.printStackTrace();
