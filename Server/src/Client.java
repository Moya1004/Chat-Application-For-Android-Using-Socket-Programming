		...
		while(true) {
			...
			if(msg.equalsIgnoreCase("LOGOUT")) {
                ...
                // message to check who are present in chatroom
                    ...
                    client.sendMessage(new ChatMessage(ChatMessage.CREATE_GROUP, msg.toLowerCase().replace("create group ","")));
                }
                else if(msg.toLowerCase().startsWith("register for group ")) {
                    client.sendMessage(new ChatMessage(ChatMessage.REGISTER_FOR_GROUP, msg.toLowerCase().replace("register for group ","")));
                }
                else if(msg.toLowerCase().startsWith("message group ")) {
                    client.sendMessage(new ChatMessage(ChatMessage.MESSAGE_GROUP, msg.toLowerCase().replace("message group ","")));
                }
